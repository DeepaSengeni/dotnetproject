...
basicStyling = function(answer_span,top_elements){
    ...
    if(jq(window).width() <= 550){
        jq(answer_span).css('min-width', jq(window).width()-70);
        jq(answer_span).css('max-width', jq(window).width()-70);
        top_elements.toolbar.css('min-width',jq(window).width()-70);
        top_elements.toolbar.css('max-width',jq(window).width()-70);
    }
};
