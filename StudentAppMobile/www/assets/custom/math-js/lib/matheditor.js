function MathEditor(id){
    ...
    this.default_toolbar_buttons = [
      ...
      'round_curlybrackets',
      'round_bigbrackets',
      'doubleround_brackets',
      'doubleround_curlybrackets',
      'doubleround_bigbrackets',
      'binom',
      'fractionwithfunction',
      'Trisin',
      'Tricos',
      'Tritan',
      'Tricsc',
  ...
  this.default_toolbar_tabs = ["General", "Symbols", "Geometry","Trigonometry"];

  button_meta = {
    "default_toolbar_tabs" : ["General", "Symbols", "Geometry", "Trigonometry"],
    "thetav":               { latex: "\\vartheta", moveto: "Up", movefor: 1, tab: 1, icon: '\\vartheta' },
    ...
    "pibynumber":           { latex: "\\frac\\pi{}", moveto: "Down", movefor: 1, tab: 1, icon: '\\frac\\pi{\\square}' },
    "pibyno":               { latex: "\\pi/{}", tab: 1, icon: '\\pi/{\\square}' },
    "customsuperscript":    { latex: "{}^{}", moveto: "Up", movefor: 1, tab: 1, icon: '\\square_{\\square}'},
    "customsubscript":      { latex: "{}_{}", moveto: "Down", movefor: 1, tab: 1, icon: '{\\square}^{\\square}' }, 
    "Unkonwnroot":          { latex: "\\sqrt[2]{}", moveto: "Left", movefor: 1, tab: 1, icon: '\\sqrt[2]{\\square}' },
    "Underrootplus":        { latex: "\\sqrt{{x}^2+{x}^2}", moveto: "Left", movefor: 1, tab: 1, icon: '\\sqrt{\\square^2+\\square^2}' },
    "Complexroot":          { latex: "\\frac{-{x}\\pm\\sqrt{{x}^{x}-4{x}{x}}}{2{x}}", tab: 1, icon: '\\frac{-{\\square}\\pm\\sqrt{\\square}}{2{\\square}}' },
    "dy/dx":                { latex: "\\frac{dy}{dx}", moveto: "Up", movefor: 1, tab: 1, icon: '\\frac{dy}{dx}' },
    "dy/dx2":               { latex: "\\frac{\\triangle{y}}{\\triangle{x}}", moveto: "Up", movefor: 1, tab: 1, icon: '\\frac{\\triangle{y}}{\\triangle{x}}' },
    "delta_y/delta_x":      { latex: "\\frac{\\delta {y}}{\\delta{x}}", moveto: "Up", movefor: 1, tab: 1, icon: '\\frac{\\delta{y}}{\\delta{x}}' },
    "partial_y/partial_x":  { latex: "\\frac{\\partial {y}}{\\partial{x}}", moveto: "Up", movefor: 1, tab: 1, icon: '\\frac{\\partial{y}}{\\partial{x}}' },
    "Integration":          { latex: "\\int{x}", moveto: "Right", movefor: 1, tab: 1, icon: '\\int\\square' },
    "doubleIntegration":    { latex: "\\int\\int{x}", moveto: "Right", movefor: 1, tab: 1, icon: '\\int\\int\\square' },
    "tripleIntegration":    { latex: "\\int\\int\\int{x}", moveto: "Right", movefor: 1, tab: 1, icon: '\\int\\int\\int\\square' },
    "Integral":             { latex: "\\int_{-a}^{b} d{x}", moveto:"Up", movefor:1, tab: 1, icon: '\\int_{-a}^{b} dx' },
    "doubleIntegral":       { latex: "\\int\\int_{-a}^{b} d{x}", moveto: "Up", movefor: 1, tab: 1, icon: '\\int\\int_{-a}^{b} dx' },
    "tripleIntegral":       { latex: "\\int\\int\\int_{-a}^{b} d{x}", moveto: "Up", movefor: 1, tab: 1, icon: '\\int\\int\\int_{-a}^{b} dx' },
    "singleoint":           { latex: "\\oint{x}", moveto: "Right", movefor: 1, tab: 1, icon: '\\oint\\square' },
    "doubleoint":           { latex: "\\oint\\oint{x}", moveto: "Right", movefor: 1, tab: 1, icon: '\\oint\\oint\\square' },
    "tripleoint":           { latex: "\\oint\\oint\\oint{x}", moveto: "Right", movefor: 1, tab: 1, icon: '\\oint\\oint\\oint\\square' },
    "oiint_V":              { latex: "\\oint_{-a}^{b} d{x}", moveto: "Up", movefor: 1, tab: 1, icon: '\\oint_{-a}^{b} d{x}' },
    "doubleoiint_V":        { latex: "\\oint\\oint_{-a}^{b} d{x}", moveto: "Up", movefor: 1, tab: 1, icon: '\\oint\\oint_{-a}^{b} d{x}' },
    "tripleoiint_V":        { latex: "\\oint\\oint\\oint_{-a}^{b} d{x}", moveto: "Up", movefor: 1, tab: 1, icon: '\\oint\\oint\\oint_{-a}^{b} d{x}' },
    "round_curlybrackets":  { latex: "\\left\\{\\right\\}", moveto: "Left", movefor: 1, tab: 1, icon: '\\left\\{\\square\\right\\}' },
    "round_bigbrackets":    { latex: "\\left[\\right]", moveto: "Left", movefor: 1, tab: 1, icon: '\\left[\\square\\right]' }, 
    "doubleround_brackets": { latex: "\\left({x}\\vert{x}\\right)", moveto: "Left", movefor: 1, tab: 1, icon: '\\left(\\square\\vert\\square\\right)' },
    "doubleround_curlybrackets": { latex: "\\left\\{{x}\\vert{x}\\right\\}", moveto: "Left", movefor: 1, tab: 1, icon: '\\left\\{\\square\\vert\\square\\right\\}' },
    "doubleround_bigbrackets":   { latex: "\\left[{x}\\vert{x}\\right]", moveto: "Left", movefor: 1, tab: 1, icon: '\\left[\\square\\vert\\square\\right]' },
    "binom":                { latex: "\\binom{m}{m}", moveto: "Up", movefor: 1, tab: 1, icon: '\\binom{\\square}{\\square}' },
    "fractionwithfunction": { latex: "\\binom{m}{m}", moveto: "Up", movefor: 1, tab: 1, icon: '\\binom{\\square}{\\square}' },
    "Trisin":              { latex: "\\sin{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\sin{\\square}' },
    "Tricos":              { latex: "\\cos{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\cos{\\square}' },
    "Tritan":              { latex: "\\tan{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\tan{\\square}' },
    "Tricsc":              { latex: "\\csc{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\csc{\\square}' },
    "Trisec":              { latex: "\\sec{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\sec{\\square}' },
    "Tricot":              { latex: "\\cot{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\cot{\\square}' },
    "sininverse":          { latex: "\\sin^-1{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\sin^-1{\\square}' },
    "cosinverse":          { latex: "\\cos^-1{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\cos^-1{\\square}' },
    "taninverse":          { latex: "\\tan^-1{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\tan^-1{\\square}' },
    "cscinverse":          { latex: "\\csc^-1{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\csc^-1{\\square}' },
    "secinverse":          { latex: "\\sec^-1{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\sec^-1{\\square}' },
    "cotinverse":          { latex: "\\cot^-1{x}", moveto: "Right", movefor: 1, tab: 4, icon: '\\cot^-1{\\square}' },
  ...
  keyboard_keys = {
    'letters': [
      ...
      { 'value': '\\ ', 'type': 'write', 'class': 'ks too_long', 'display': 'Space', 'new_line': false },
      { 'value': '.', 'type': 'write', 'class': 'ks', 'display': '.', 'new_line': false },
      { 'value': 'close', 'type': 'custom', 'class': 'ks long takeup', 'display': 'X', 'new_line': false }],
 'numbers': [{ 'value': '1', 'type': 'write', 'class': 'ks', 'display': '1', 'new_line': false },
      ...
      { 'value': '%', 'type': 'write', 'class': 'ks', 'display': '%', 'new_line': false },
      { 'value': 'close', 'type': 'custom', 'class': 'ks long takeup', 'display': 'X', 'new_line': false },
      { 'value': 'symbole', 'type': 'custom', 'class': 'ks long', 'display': '@!#', 'new_line': false }],
    'symbole': [{ 'value': '!', 'type': 'write', 'class': 'ks', 'display': '!', 'new_line': false },
      { 'value': '@', 'type': 'write', 'class': 'ks', 'display': '@', 'new_line': false },
      { 'value': '#', 'type': 'write', 'class': 'ks', 'display': '/', 'new_line': false },
      { 'value': '%', 'type': 'write', 'class': 'ks', 'display': '%', 'new_line': false },
      { 'value': '^', 'type': 'write', 'class': 'ks', 'display': '^', 'new_line': false },
...
MathEditor.prototype.setTemplate = function(name){
    if (name=='floating-toolbar'){
        ...
        jq(this.answerSpan).focusin(function(o){
            ...
            mathed_tmp[jq(o.currentTarget).attr('id')].toolbar.show();
        });
    }else{
...
keyboardAction = function(top_elements,answer_span,field){
    ...
    jq('#keys-'+editor_id).find('a').on('click', function(o){
        ...
        if(type=='keystroke'){
            ...
            else if (value == 'symbole') {
              jq('.keyboard-letters-' + editor_id).remove();
              setVirtualKeyboard(top_elements, answer_span, field, "symbole", 10);
              jq('.keyboard-symbole-' + editor_id).parent().show();
            }
...
basicStyling = function(answer_span,top_elements){
  jq(answer_span).css('min-width', 350);
  jq(answer_span).css('max-width', 350);
  jq(answer_span).css('min-height', 40);
  jq(answer_span).css('max-height', 40);
  ...
  jq(answer_span).css('overflow', 'auto');
    ...
    if(jq(window).width() <= 550){
        jq(answer_span).css('min-width', 350);
        jq(answer_span).css('max-width', 350);
        top_elements.toolbar.css('min-width',350);
        top_elements.toolbar.css('max-width',350);
    }
};
