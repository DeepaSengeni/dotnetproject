...
(function($) {
    var methods = {
        ...
        init: function(Options) {
            var OptionsIfEmpty = {
                ActionToSubmitUpload: "http://picturecut.tuyoshi.com.br/src/php/upload.php",
                ActionToSubmitCrop: "http://picturecut.tuyoshi.com.br/src/php/crop.php",
                DefaultImageButton: "http://picturecut.tuyoshi.com.br/src/img/icon_add_image2.png"
            };
            var defaults = {
            ...
            __IMAGE_LOADING = "http://localhost:28016/Images/src/img/ajaxloader.gif";
