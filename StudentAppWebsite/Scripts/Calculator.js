...
function gotoSpecialSymbols1() {
    ...
    '<span class="KeyboardKey" onclick="gotoSpecialSymbols()"> <a href="javascript:;" class="button imgpos"><img src="/KeyboardIcons/images/special character/previous.PNG" /></a></span></div>',
         '<div class="col-md-12"><div style="text-align:center" class="spcl">',
...
function loadCapitalLetters() {
   ...
   '<div style="text-align:center">',
    ...
    '<span class="KeyboardKey" data-attr="161" data-text="L"> <a href="javascript:;" class="button"><img src="/KeyboardIcons/images/querty keyboard/l.PNG" /></a></span>',
     ...
     '</div>',
      '<div style="text-align:center">',
        '<span class="" onclick="' + (preserveCount < 2 ? "loadCapitalLetters()" : "gotoQWETY()") + '"> <a href="javascript:;" class="button" style="background: linear-gradient(to bottom, rgb(6, 106, 204) 12%, rgb(8, 90, 173) 67%);"><img src="/KeyboardIcons/images/special character/shift3.PNG" /></a></span>',
